...
----------------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/37/A ----------------------------------------

Little Vasya has received a young builder’s kit. The kit consists of several wooden bars, the lengths of all of them are known. 
...
print(sorted_counts[0][1], len(counts))