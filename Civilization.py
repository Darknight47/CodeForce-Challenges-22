...
----------------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1625/A ---------------------------------------
...
Let the word have n forms, the i-th of which is described with an integer xi. All the xi are not necessarily different, as two various forms of the word can be written the same. Consider some word y. 
...
for _ in range(cases):
    ...
    binary_list = [format(x, 'b').zfill(l) for x in arr]
    temp = ''
    for i in range(l):
        zeros = 0
        ones = 0
